...
// Adicione isso ao seu arquivo comunidade.js

document.addEventListener('DOMContentLoaded', function() {
    const checkboxMenorIdade = document.getElementById('menorIdade');
    const secaoResponsavel = document.getElementById('secao-responsavel'); // Você precisa adicionar este ID no HTML

    // Função para mostrar ou esconder a seção
    ...
    // Adiciona o evento para quando o checkbox mudar
